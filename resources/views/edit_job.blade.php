                            ...
                            <div class="card-body card-form p-4">
                                ...
                                {{-- <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <div class="d-flex">
                                            <input value="{{$job->salary  }}" type="number"  placeholder="Salary" id="salary" name="salary" class="form-control me-2" style="flex: 4;"min="0">
                                            <select name="salary_unit" id="salary_unit" class="form-select" style="flex: 2;">

                                                <option value=""> Salary Type</option>
                                                @if ($selary->isNotEmpty())
                                                @foreach ( $selary as  $selaryType)
                                                <option {{ $job->selary_type_id == $selaryType->id ? 'selected' : '' }} value="{{  $selaryType->id }}">{{  $selaryType->name }}</option>
                                                @endforeach
                ...
                success: function(response) {
                    ...
                    if (response.status == true) {
                        ...
                        $("#company_name").removeClass('is-invalid')
                            ...
                            .removeClass('invalid-feedback')
                            .html('');
                     // Clear salary field errors

                         $("#salary").removeClass('is-invalid')
                            .siblings('p')
                            .removeClass('invalid-feedback')
                            .html('');
                          $("#salary_unit").removeClass('is-invalid')
                            .siblings('p')
                            .removeClass('invalid-feedback')
                            .html('');
                    ...
                    if (errors.salary) {
                     ...
                     // Salary Unit field validation
                    if (errors.salary_unit) {
                        $("#salary_unit").addClass('is-invalid')
                            .siblings('p')
                            .addClass('invalid-feedback')
                            .html(errors.salary_unit);
                    } else {
                        $("#salary_unit").removeClass('is-invalid')
                            .siblings('p')
                            .removeClass('invalid-feedback')
