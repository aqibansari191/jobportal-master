                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input value="{{ $jobs->title }}" type="text" placeholder="Job Title" id="title" name="title"
                                            class="form-control">
                                        <p></p>
                                    </div>
                                    <div class="col-md-6  mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        <div class="form-check-inline">
                                         <input {{ ($jobs->status == 1)?'checked':'' }} class="form-check-input" type="radio" value="1" id="status" name="status">
                                        ...
                                        <div class="form-check-inline">
                                         <input {{ ($jobs->status == 0)?'checked':'' }} class="form-check-input" type="radio" value="0" id="status-block" name="status">
                                         <label class="form-check-label" for="status">
                                           Block
                                         </label>
                                        </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input value="{{ $jobs->company_website }}" type="text" placeholder="Website" id="website" name="website"
                                        class="form-control">
                                </div>
                            </div>
...
$("#editJobForm").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('admin.Jobupdate',$jobs->id) }}",
                type: 'PUT',
                dataType: 'json',
