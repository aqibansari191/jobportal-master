                                        ...
                                        @if ($savedJobs->isNotEmpty())
                                            @foreach ($savedJobs as $savedJob)
                                                <tr class="active">
                                                    ...
                                                    <td>{{ $savedJob->job->applications->count() }}20 Applications</td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="action-dots float-end">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" href="{{ route("jobDetail",$savedJob->job->id) }}"> <i class="fa-eye" aria-hidden="true"></i> View</a></li>
