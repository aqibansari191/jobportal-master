                            ...
                            <div class="card-body card-form p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-4 col-md-6">
                                        ...
                                        <div class="d-flex">
                                            <input type="number" placeholder="Salary" id="salary" name="salary" class="form-control me-2" style="flex: 4;"min="0">
                                            <select name="salary_unit" id="salary_unit" class="form-select" style="flex: 2;">
                                                ...
                                                <option value="{{  $selaryType->id }}">{{  $selaryType->name }}</option>
                                                @endforeach
